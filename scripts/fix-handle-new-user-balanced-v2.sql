-- Balanced fix for handle_new_user that allows both signup AND email confirmation to work (V2)
...
-- Simple verification without the problematic test
SELECT 'Balanced handle_new_user function applied' as status;
SELECT 'This should fix both signup AND email confirmation issues' as message;
