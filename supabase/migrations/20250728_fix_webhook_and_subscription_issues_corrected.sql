...
BEGIN
  ...
  BEGIN
    ...
    -- Use the partial index for conflict resolution
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '=== WEBHOOK FIX APPLIED (CORRECTED) ===';
  RAISE NOTICE 'Fixed issues:';
  RAISE NOTICE '1. ✅ HTTP extension availability check added';
  RAISE NOTICE '2. ✅ Subscription constraint fixed with partial unique index';  
  RAISE NOTICE '3. ✅ Trigger function updated with better error handling';
  RAISE NOTICE '4. ✅ Fixed ON CONFLICT to work with partial index';
  RAISE NOTICE '';
